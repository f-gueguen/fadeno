...
const expectedA0 = [
  ...
  { id: "A0-07", features: ["CLI-01", "DX-01", "DOC-01", "ACCESS-01", "TEST-01"], dependencies: "A0-05, A0-06", artifacts: "ADR 0042; versioned task packet and anonymized observations for install/create/test/check/dev/build/deploy, seeded diagnostics/corrections/flows/recovery, and missing workflows", validation: "`pnpm check:a0-usability-contract`; `pnpm check:a0-usability-replay-contract`; independent real replay; exact artifact identity; all attempts retained; no fabricated success; `pnpm ci:local`", commands: ["pnpm check:a0-usability-contract", "pnpm check:a0-usability-replay-contract", "pnpm ci:local"] },
