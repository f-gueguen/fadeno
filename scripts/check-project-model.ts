...
const expectedA0 = [
  ...
  { id: "A0-10", features: ["CLI-01", "DOC-01", "REL-01"], dependencies: "A0-09", artifacts: "Mechanical release commit, exact tag, public package, immutable docs artifact, install verification, release notes", validation: "`pnpm check:a0-first-alpha-release`; tag/source/package/docs identity; `pnpm verify:a0-public-alpha`; clean public install/create/test/check/build/deploy; rollback drill; `pnpm ci:local`", commands: ["pnpm check:a0-first-alpha-release", "pnpm verify:a0-public-alpha", "pnpm ci:local"] },
] as const;
