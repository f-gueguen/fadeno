...
for (const path of [
  ...
  "examples/v1-app/scenarios/form-submission/expected/fragment-limit-refusal.json",
  "examples/v1-app/scenarios/form-submission/expected/fragment-limit-refusal-human.txt",
  ...
  "examples/v1-app/scenarios/form-submission/expected/formdata-observer-recovery.json",
  "examples/v1-app/scenarios/form-submission/expected/formdata-observer-recovery-human.txt",
  ...
  "examples/v1-app/scenarios/form-submission/expected/final-formdata-routing.json",
  "examples/v1-app/scenarios/form-submission/expected/final-formdata-routing-human.txt",
  "examples/v1-app/scenarios/form-submission/expected/formdata-snapshot-limit.json",
  "examples/v1-app/scenarios/form-submission/expected/formdata-snapshot-limit-human.txt",
  ...
  "examples/v1-app/scenarios/form-submission/expected/forward-history-fragment-recovery.json",
  "examples/v1-app/scenarios/form-submission/expected/forward-history-fragment-recovery-human.txt",
...
for (const fragment of [
  ...
  "final-`formdata`/image/bounded-candidate overflow/microtask and observer-cleanup evidence",
...
for (const [path, fragment] of [
  ...
  ["examples/v1-app/scenarios/form-submission/expected/handoff-option-wrapper.json", '"outcome": "structure-changes-recovered"'],
  ["examples/v1-app/scenarios/form-submission/expected/handoff-option-wrapper.json", '"wrapperTextEditRecovered": true'],
  ["examples/v1-app/scenarios/form-submission/expected/handoff-option-wrapper.json", '"wrapperTextMoveRecovered": true'],
  ...
  ["examples/v1-app/scenarios/form-submission/expected/fragment-limit-refusal.json", '"flowCode": "FADENO_UPDATE_LIMIT"'],
  ["examples/v1-app/scenarios/form-submission/expected/fragment-limit-refusal.json", '"destinationNotPublished": true'],
  ...
  ["examples/v1-app/scenarios/form-submission/expected/formdata-observer-recovery.json", '"observersRetained": 0'],
  ["examples/v1-app/scenarios/form-submission/expected/formdata-observer-recovery.json", '"formDataEvents": 1'],
  ...
  ["examples/v1-app/scenarios/form-submission/expected/formdata-microtask-recovery.json", '"snapshotReadBeforeListenerMicrotask": true'],
  ["examples/v1-app/scenarios/form-submission/expected/formdata-microtask-recovery.json", '"currentTruthRenderObserved": true'],
  ["examples/v1-app/scenarios/form-submission/expected/final-formdata-routing.json", '"originalRoutingNotRetained": true'],
  ["examples/v1-app/scenarios/form-submission/expected/final-formdata-routing.json", '"programmaticCandidateQualification": "available"'],
  ["examples/v1-app/scenarios/form-submission/expected/final-formdata-routing.json", '"overflowDestinationNotPublished": true'],
  ["examples/v1-app/scenarios/form-submission/expected/formdata-snapshot-limit.json", '"browserOwnedFormDataEvents": 1'],
  ["examples/v1-app/scenarios/form-submission/expected/formdata-snapshot-limit.json", '"boundedIteratorSteps": 1'],
  ["examples/v1-app/scenarios/form-submission/expected/formdata-snapshot-limit.json", '"oversizedValueWasNotCloned": true'],
  ...
  ["examples/v1-app/scenarios/form-submission/expected/forward-history-fragment-recovery.json", '"recoveryDidNotRequireLengthGrowth": true'],
  ["examples/v1-app/scenarios/form-submission/expected/forward-history-fragment-recovery.json", '"backReachedPrecedingPage": true'],
...
for (const fragment of [
  ...
  '"scenarios/form-submission/expected/fragment-limit-refusal.json"',
  '"scenarios/form-submission/expected/fragment-limit-refusal-human.txt"',
  ...
  '"scenarios/form-submission/expected/formdata-observer-recovery.json"',
  '"scenarios/form-submission/expected/formdata-observer-recovery-human.txt"',
  ...
  '"scenarios/form-submission/expected/final-formdata-routing.json"',
  '"scenarios/form-submission/expected/final-formdata-routing-human.txt"',
  '"scenarios/form-submission/expected/formdata-snapshot-limit.json"',
  '"scenarios/form-submission/expected/formdata-snapshot-limit-human.txt"',
  ...
  '"scenarios/form-submission/expected/forward-history-fragment-recovery.json"',
  '"scenarios/form-submission/expected/forward-history-fragment-recovery-human.txt"',
