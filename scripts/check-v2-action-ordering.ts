...
for (const path of [
  ...
  "examples/v1-app/scenarios/form-submission/expected/close-recovery-fallback.json",
  "examples/v1-app/scenarios/form-submission/expected/close-recovery-fallback-human.txt",
  ...
  "examples/v1-app/scenarios/form-submission/expected/handoff-option-wrapper.json",
  "examples/v1-app/scenarios/form-submission/expected/handoff-option-wrapper-human.txt",
  ...
  "examples/v1-app/scenarios/form-submission/expected/recovery-formdata-routing-refusal.json",
  "examples/v1-app/scenarios/form-submission/expected/recovery-formdata-routing-refusal-human.txt",
  "examples/v1-app/scenarios/form-submission/expected/departure-observer-cleanup.json",
  "examples/v1-app/scenarios/form-submission/expected/departure-observer-cleanup-human.txt",
  "examples/v1-app/scenarios/form-submission/expected/post-dispatch-formdata.json",
  "examples/v1-app/scenarios/form-submission/expected/post-dispatch-formdata-human.txt",
  "examples/v1-app/scenarios/form-submission/expected/formdata-microtask-recovery.json",
  "examples/v1-app/scenarios/form-submission/expected/formdata-microtask-recovery-human.txt",
  ...
  "examples/v1-app/scenarios/form-submission/expected/native-empty-fragment-form.json",
  "examples/v1-app/scenarios/form-submission/expected/native-empty-fragment-form-human.txt",
  ...
  "examples/v1-app/scenarios/form-submission/expected/persisted-reacquisition-recovery.json",
  "examples/v1-app/scenarios/form-submission/expected/persisted-reacquisition-recovery-human.txt",
  ...
  "examples/v1-app/scenarios/form-submission/expected/fragment-rollback-traversal-failure.json",
  "examples/v1-app/scenarios/form-submission/expected/fragment-rollback-traversal-failure-human.txt",
  ...
  "examples/v1-app/scenarios/form-submission/expected/fragment-rollback-selection-refusal.json",
  "examples/v1-app/scenarios/form-submission/expected/fragment-rollback-selection-refusal-human.txt",
  ...
  "examples/v1-app/scenarios/form-submission/expected/fragment-redirect-history.json",
  "examples/v1-app/scenarios/form-submission/expected/fragment-redirect-history-human.txt",
  "examples/v1-app/scenarios/form-submission/expected/fragment-close-recovery-fallback.json",
  "examples/v1-app/scenarios/form-submission/expected/fragment-close-recovery-fallback-human.txt",
...
for (const fragment of [
  ...
  "push-write sequence",
  "exact requested source entry",
  "sixteen distinct",
  "persisted page resumes",
  "rollback traversal call throws synchronously",
...
for (const fragment of [
  ...
  "retains at most sixteen distinct derived destinations",
  "matching the browser-selected URL remains authoritative",
  "persisted page closes enhancement",
...
for (const fragment of [
  ...
  "final-`formdata`/image/bounded-candidate microtask evidence",
  "persisted-page reacquisition recovery",
...
for (const fragment of [
  ...
  "later formdata microtasks displace the final native GET destination",
  "persisted page cannot reacquire history ownership",
  "fragment rollback traversal throws synchronously",
...
for (const [path, fragment] of [
  ...
  ["examples/v1-app/scenarios/form-submission/expected/close-recovery-fallback.json", '"nativeCurrentTruthGets": 1'],
  ["examples/v1-app/scenarios/form-submission/expected/close-recovery-fallback.json", '"enhancementRestarted": true'],
  ...
  ["examples/v1-app/scenarios/form-submission/expected/fragment-rollback-selection-refusal.json", '"selectedEntryVisible": true'],
  ...
  ["examples/v1-app/scenarios/form-submission/expected/recovery-formdata-routing-refusal.json", '"mutationRetried": false'],
  ["examples/v1-app/scenarios/form-submission/expected/departure-observer-cleanup.json", '"departureObserversRetained": 0'],
  ["examples/v1-app/scenarios/form-submission/expected/post-dispatch-formdata.json", '"formDataEvents": 2'],
  ["examples/v1-app/scenarios/form-submission/expected/post-dispatch-formdata.json", '"finalHash": "#post-dispatch"'],
  ["examples/v1-app/scenarios/form-submission/expected/formdata-microtask-recovery.json", '"unrelatedSnapshotRefused": true'],
  ["examples/v1-app/scenarios/form-submission/expected/formdata-microtask-recovery.json", '"currentTruthRenderObserved": true'],
  ...
  ["examples/v1-app/scenarios/form-submission/expected/native-form-fragment-recovery.json", '"emptyQueryDelimiterRetained": true'],
  ["examples/v1-app/scenarios/form-submission/expected/native-form-fragment-recovery.json", '"nativeCurrentTruthGetsAtLeastFour": true'],
  ["examples/v1-app/scenarios/form-submission/expected/native-form-fragment-recovery.json", '"imageSubmitterFormDataEvents": 2'],
  ["examples/v1-app/scenarios/form-submission/expected/native-empty-fragment-form.json", '"finalUrlEndsWithEmptyQueryAndFragment": true'],
  ["examples/v1-app/scenarios/form-submission/expected/native-empty-fragment-form.json", '"nativeDestinationGets": 1'],
  ["examples/v1-app/scenarios/form-submission/expected/fragment-redirect-history.json", '"historyEntriesAdded": 1'],
  ["examples/v1-app/scenarios/form-submission/expected/fragment-redirect-history.json", '"backReachedFragmentFreeEntry": true'],
  ["examples/v1-app/scenarios/form-submission/expected/fragment-close-recovery-fallback.json", '"nativeCurrentTruthGets": 1'],
  ["examples/v1-app/scenarios/form-submission/expected/fragment-close-recovery-fallback.json", '"enhancementRestarted": true'],
  ...
  ["examples/v1-app/scenarios/form-submission/expected/persisted-reacquisition-recovery.json", '"enhancementRestarted": true'],
  ["examples/v1-app/scenarios/form-submission/expected/persisted-reacquisition-recovery.json", '"mutationRetried": false'],
  ...
  ["examples/v1-app/scenarios/form-submission/expected/fragment-rollback-traversal-failure.json", '"nativeCurrentTruthGets": 1'],
...
for (const fragment of [
  ...
  '"scenarios/form-submission/expected/close-recovery-fallback.json"',
  '"scenarios/form-submission/expected/close-recovery-fallback-human.txt"',
  ...
  '"scenarios/form-submission/expected/handoff-option-wrapper.json"',
  '"scenarios/form-submission/expected/handoff-option-wrapper-human.txt"',
  ...
  '"scenarios/form-submission/expected/recovery-formdata-routing-refusal.json"',
  '"scenarios/form-submission/expected/recovery-formdata-routing-refusal-human.txt"',
  '"scenarios/form-submission/expected/departure-observer-cleanup.json"',
  '"scenarios/form-submission/expected/departure-observer-cleanup-human.txt"',
  '"scenarios/form-submission/expected/post-dispatch-formdata.json"',
  '"scenarios/form-submission/expected/post-dispatch-formdata-human.txt"',
  ...
  '"scenarios/form-submission/expected/native-empty-fragment-form.json"',
  '"scenarios/form-submission/expected/native-empty-fragment-form-human.txt"',
  '"scenarios/form-submission/expected/formdata-microtask-recovery.json"',
  '"scenarios/form-submission/expected/formdata-microtask-recovery-human.txt"',
  ...
  '"scenarios/form-submission/expected/persisted-reacquisition-recovery.json"',
  '"scenarios/form-submission/expected/persisted-reacquisition-recovery-human.txt"',
  ...
  '"scenarios/form-submission/expected/fragment-rollback-traversal-failure.json"',
  '"scenarios/form-submission/expected/fragment-rollback-traversal-failure-human.txt"',
  ...
  '"scenarios/form-submission/expected/fragment-redirect-history.json"',
  '"scenarios/form-submission/expected/fragment-redirect-history-human.txt"',
  '"scenarios/form-submission/expected/fragment-close-recovery-fallback.json"',
  '"scenarios/form-submission/expected/fragment-close-recovery-fallback-human.txt"',
...
for (const path of [
  ...
  assert.equal(
    documentationSourceDocument.evidence?.staleRemoval?.includes(path),
    true,
    `${path} must participate in stale artifact cleanup`,
  );
}
