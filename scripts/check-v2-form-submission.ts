...
try {
  ...
  for (const name of ["success.json", "failure.json", "failure-human.txt", "correction.json", "flow.json", "recovery.json", "history-recovery.json", "terminal-flow.json", "security.json", "privacy.json", "teardown.json", "crud.json", "ordering.json", "ordering-human.txt", "native-crud.json", "duplicate.json", "duplicate-human.txt", "concurrency.json", "concurrency-human.txt", "close-recovery.json", "staged-recovery.json", "handoff-edit-recovery.json", "handoff-edit-recovery-human.txt", "handoff-limit-refusal.json", "handoff-limit-refusal-human.txt", "redirect-recovery-outcome.json", "redirect-recovery-outcome-human.txt", "handoff-caret-recovery.json", "handoff-caret-recovery-human.txt", "pending-handoff.json", "pending-handoff-human.txt", "supersession-recovery.json", "supersession-recovery-human.txt", "native-supersession-recovery.json", "native-supersession-recovery-human.txt", "native-no-departure-recovery.json", "native-no-departure-recovery-webkit.json", "native-no-departure-recovery-human.txt", "native-form-fragment-recovery.json", "native-form-fragment-recovery-human.txt", "submit-propagation-recovery.json", "submit-propagation-recovery-human.txt", "late-target-recovery.json", "late-target-recovery-human.txt", "recovery-supersession-continuity.json", "recovery-supersession-continuity-human.txt", "recovery-handoff-preservation.json", "recovery-handoff-preservation-human.txt", "cancelled-fragment-push-recovery.json", "cancelled-fragment-push-recovery-human.txt", "failed-fragment-push-recovery.json", "failed-fragment-push-recovery-human.txt", "file-handoff-recovery.json", "file-handoff-recovery-human.txt", "fragment-redirect.json", "fragment-redirect-human.txt", "fragment-redirect-chain.json", "fragment-redirect-chain-human.txt", "redirect-get-consumption.json", "redirect-get-consumption-human.txt", "traversal-recovery.json", "traversal-recovery-human.txt"]) {
