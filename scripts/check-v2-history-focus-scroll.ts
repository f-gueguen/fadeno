...
for (const fragment of [
  ...
  "retains copied-state recovery when reload clears the selected entry",
  ...
  "captures rollback focus and selection from the precommit document snapshot",
  "rolls back a destination whose metadata changes during commit",
  ...
  "history-cancelled-unsafe-repair",
...
for (const name of [
  ...
  "history-exact-application-recovery",
  "history-cleared-entry-recovery-refusal",
  ...
  "history-precommit-metadata-recovery",
