...
| Public browser update protocol | A demonstrated external consumer and a later ADR establish compatibility ownership; ADRs 0047 and 0048 keep the encoder, decoder, envelope, projection record, and metrics private even though the explicit browser bootstrap is public |
