...
| Public browser update protocol | A demonstrated external consumer and a later ADR establish compatibility ownership; ADRs 0047 through 0049 keep the encoder, decoder, envelope, projection record, navigation transport, and metrics private even though the explicit browser bootstrap is public |
