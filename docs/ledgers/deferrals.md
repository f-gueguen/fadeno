...
| Public browser update protocol | A demonstrated external consumer and a later ADR establish compatibility ownership; ADR 0047 keeps the encoder, decoder, envelope, and metrics private even though the explicit browser bootstrap is public |
