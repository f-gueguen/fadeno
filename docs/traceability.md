...
| PATCH-01 | [ADR 0003](adr/0003-progressive-enhancement-baseline.md), [ADR 0007](adr/0007-tiered-interactivity-direction.md) | [Navigation/patching](spec/navigation-patching-preservation.md) | H1; K0-02 harness only | K0/V2 | Three-engine harness integrity, then repeated preservation corpus |
