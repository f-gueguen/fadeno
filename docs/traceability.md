...
| TEST-01 | [ADR 0009](adr/0009-documentation-and-evidence-authority.md), [ADR 0012](adr/0012-evidence-gated-support-and-operations.md) | [Build/adapters/testing](spec/build-adapters-testing.md) | K0-01 harness | K0/V1 | Unit, type, integration, no-JS, browser, security, adapter suites |
...
| PATCH-01 | [ADR 0003](adr/0003-progressive-enhancement-baseline.md), [ADR 0007](adr/0007-tiered-interactivity-direction.md) | [Navigation/patching](spec/navigation-patching-preservation.md) | H1 | K0/V2 | Three-engine repeated preservation corpus |
...
| PERF-01 | [ADR 0012](adr/0012-evidence-gated-support-and-operations.md) | [Build/adapters/testing](spec/build-adapters-testing.md), [K0 plan](roadmap/k0.md) | Frozen environment and relative baselines | K0/A0/B0 | Compiler/build/server/browser benchmark manifests and budget checks |
