...
| PERF-01 | [ADR 0012](adr/0012-evidence-gated-support-and-operations.md), [ADR 0017](adr/0017-h3-local-docker-reference.md), [ADR 0019](adr/0019-h4-local-docker-reference.md) | [Build/adapters/testing](spec/build-adapters-testing.md), [K0 plan](roadmap/k0.md) | Frozen browser reference plus scoped H3/H4 local Docker references; H3 measured NARROW and H4 remains unqualified | K0/A0/B0 | `pnpm check:reference-image`, `pnpm check:type-spine-qualification-evidence`, `pnpm experiment:revalidation -- --verify-qualification`, and later server/browser budget checks |
