...
| TYPE-01 | [ADR 0002](adr/0002-standard-typescript-and-html-shaped-jsx.md), [ADR 0004](adr/0004-structural-execution-boundaries.md), [ADR 0018](adr/0018-narrow-type-spine-incremental-generation.md) | [Compiler/analyzer](spec/compiler-analyzer.md) | H3 narrowed; DG-V1-02 | K0/V1 | `pnpm check:type-spine-qualification-evidence` plus stock-TypeScript positive/negative and reproducibility corpus |
...
| BUILD-01 | [ADR 0011](adr/0011-supported-developer-workflow.md), [ADR 0022](adr/0022-toolchain-and-configuration-contract.md) | [Build/adapters/testing](spec/build-adapters-testing.md) | DG-V1-01; toolchain command/config contract resolved | V1 | Boundary check, clean and repeated build, invalid config, secret scan |
| ADP-01 | [ADR 0008](adr/0008-web-standard-server-boundary.md), [ADR 0023](adr/0023-node-http-initial-adapter.md) | [Build/adapters/testing](spec/build-adapters-testing.md) | Node 22.17 private feasibility passed; package boundary remains unresolved | V1 | `pnpm check:v1-adapter` and `pnpm check:v1-adapter:minimum`, then shared public request/stream/cancel/disconnect/shutdown conformance |
