...
| WEB-01 | Pages, deterministic route manifest, typed parameters and links, nested layouts, not-found and error outcomes, raw handlers | V1 | Filesystem and link syntax accepted by [ADR 0026](../adr/0026-route-filesystem-and-links.md); implementation remains V1-06 | [Routing and rendering](../spec/routing-rendering-streaming.md) |
