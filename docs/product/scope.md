...
| WEB-01 | Pages, deterministic route manifest, typed parameters and links, nested layouts, not-found and error outcomes, raw handlers | V1 | Accepted; syntax requires DG-V1-02 | [Routing and rendering](../spec/routing-rendering-streaming.md) |
...
| DATA-03 | Correctness-first action revalidation and optional verified `keeps` optimization | K0/V1 | Hypothesis H4 within accepted direction | [Data consistency](../spec/data-consistency.md) |
...
| TYPE-01 | Stock-TypeScript route, link, form, and context type spine with deterministic declarations | K0/V1 | Hypothesis H3 | [Compiler and analyzer](../spec/compiler-analyzer.md) |
| SEC-01 | Escaping, origin/CSRF, authorization, replay, redirect, cookie, cache, protocol, upload, and logging controls | V1 | Accepted requirements; mechanism requires DG-V1-03 and DG-V1-05 | [Security requirements](../security/requirements.md) |
| BUILD-01 | Typed configuration, development server, production build, reproducible output, and clean-machine verification | V1 | Accepted; commands and config require DG-V1-07 | [Build and diagnostics](../spec/build-adapters-testing.md) |
| ADP-01 | One conforming server adapter over `Request`, `Response`, and Web Streams | V1 | Accepted; runtime choice requires DG-V1-06 | [Build and diagnostics](../spec/build-adapters-testing.md) |
...
| PATCH-01 | Server-derived updates that preserve browser, user, and island-owned state | K0/V2 | Hypothesis H1 | [Navigation and patching](../spec/navigation-patching-preservation.md) |
...
| CLI-01 | Installation, scaffold, development, build, check, and diagnostic workflows usable without private guidance | A0 | Accepted outcome; exact commands require DG-V1-07 | [Build and diagnostics](../spec/build-adapters-testing.md) |
