...
| BUILD-01 | Typed configuration, development server, production build, reproducible output, and clean-machine verification | V1 | Accepted; commands and config fixed by [ADR 0022](../adr/0022-toolchain-and-configuration-contract.md) | [Build and diagnostics](../spec/build-adapters-testing.md) |
| ADP-01 | One conforming server adapter over `Request`, `Response`, and Web Streams | V1 | Accepted; Node HTTP selected by [ADR 0023](../adr/0023-node-http-initial-adapter.md) | [Build and diagnostics](../spec/build-adapters-testing.md) |
