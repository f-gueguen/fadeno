...
| WEB-03 | Web Streams rendering, local boundaries, cancellation, disconnect, and timeout behavior | V1 | Lifecycle accepted by [ADR 0029](../adr/0029-streaming-lifecycle-and-boundary-ownership.md); renderer integration remains V1-09 | [Routing and rendering](../spec/routing-rendering-streaming.md) |
