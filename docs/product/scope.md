...
| WEB-01 | Pages, deterministic route manifest, typed parameters and links, nested layouts, not-found and error outcomes, raw handlers | V1 | Filesystem and metadata routing implemented by V1-06; generated application binding and matched-route execution accepted by [ADR 0031](../adr/0031-jsx-renderer-and-generated-route-binding.md) for V1-09 | [Routing and rendering](../spec/routing-rendering-streaming.md) |
| WEB-02 | Server JSX rendering, contextual escaping, explicit raw HTML, document metadata, and CSP nonce propagation | V1 | Sink policy accepted by ADR 0028; narrow JSX renderer and CSP integration accepted by [ADR 0031](../adr/0031-jsx-renderer-and-generated-route-binding.md) for V1-09 | [Routing and rendering](../spec/routing-rendering-streaming.md) |
| WEB-03 | Web Streams rendering, local boundaries, cancellation, disconnect, and timeout behavior | V1 | Lifecycle accepted by ADR 0029; real renderer/adapter integration accepted by [ADR 0031](../adr/0031-jsx-renderer-and-generated-route-binding.md) for V1-09 | [Routing and rendering](../spec/routing-rendering-streaming.md) |
