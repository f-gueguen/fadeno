...
| DATA-01 | Request-scoped resources with dependency recording, deduplication, caching rules, and bounded failures | V1 | Identity, bounded input, request promise cache, failure, cancellation, and cross-request refusal accepted by [ADR 0034](../adr/0034-resource-identity-and-request-cache.md); runtime is V1-11 | [Data consistency](../spec/data-consistency.md) |
...
| DATA-03 | Correctness-first action revalidation and optional verified `keeps` optimization | K0/V1 | Accepted by [ADR 0020](../adr/0020-accept-correctness-first-revalidation.md); declaration-reference `keeps` boundary fixed by [ADR 0034](../adr/0034-resource-identity-and-request-cache.md), while the action container remains DG-V1-05 | [Data consistency](../spec/data-consistency.md) |
