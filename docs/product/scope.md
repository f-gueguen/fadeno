...
| DATA-03 | Correctness-first action revalidation and optional verified `keeps` optimization | K0/V1 | Accepted by [ADR 0020](../adr/0020-accept-correctness-first-revalidation.md); V1-11 implements complete private dependency revalidation and unsafe-`keeps` evidence under [ADR 0034](../adr/0034-resource-identity-and-request-cache.md), while the action container remains DG-V1-05 | [Data consistency](../spec/data-consistency.md) |
