...
| DATA-02 | Native forms, typed decoding, validation failures, actions, redirects, files, and duplicate-submission policy | V1 | Contract accepted by [ADR 0035](../adr/0035-native-actions-and-protected-sessions.md); public runtime remains V1-13 | [Forms and actions](../spec/forms-actions-sessions.md) |
| DATA-03 | Correctness-first action revalidation and optional verified `keeps` optimization | K0/V1 | Accepted by [ADR 0020](../adr/0020-accept-correctness-first-revalidation.md); V1-11 implements the private revalidation owner under [ADR 0034](../adr/0034-resource-identity-and-request-cache.md), and [ADR 0035](../adr/0035-native-actions-and-protected-sessions.md) selects its future action container | [Data consistency](../spec/data-consistency.md) |
| STATE-01 | Explicit URL, form, resource, session, device, element, and island state homes plus typed request context | V1/V2 | Protected session contract accepted by [ADR 0035](../adr/0035-native-actions-and-protected-sessions.md); implementation remains V1-13 | [Public model](../spec/public-model.md) |
...
| SEC-01 | Escaping, origin/CSRF, authorization, replay, redirect, cookie, cache, protocol, upload, and logging controls | V1 | Rendering security accepted by [ADR 0028](../adr/0028-contextual-rendering-security.md); native action/session mechanism accepted privately by [ADR 0035](../adr/0035-native-actions-and-protected-sessions.md) and awaits V1-13 integration | [Security requirements](../security/requirements.md) |
