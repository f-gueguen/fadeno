...
| A refused same-context activation or close occurs while work is pending | A newer eligible link aborts an ordinary pending request and remains enhanced; refused links and still-native form submissions abort pending enhanced work while remaining native; traversal ownership is repaired before native activation continues, ordinary close aborts its pending link request before teardown, and form submission is not intercepted | Three-engine rapid eligible-click, pending ordinary-request fragment-link, traversal fragment-link, native-form, ordinary-close, and delayed-recovery supersession with stale-document suppression |
